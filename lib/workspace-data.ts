...
function activityActionLabel(action: string) {
  const labels: Record<string, string> = {
    ...
    "cash.transfer_created": "Transferência entre contas registrada",
    "cash.transfer_excluded": "Transferência desconsiderada do Caixa",
    "cash.transfer_restored": "Transferência restaurada no Caixa",
    "cash.account_reconciled": "Conta financeira conciliada",
    "cash.period_closed": "Período financeiro fechado",
    "cash.period_reopened": "Período financeiro reaberto",
    "cash.receipt_attached": "Comprovante anexado ao Caixa",
    "cash.receipt_replaced": "Comprovante do Caixa substituído",
    "cash.receipt_removed": "Comprovante removido do Caixa",
    "financial_account.created": "Conta financeira criada",
    "financial_account.configured": "Saldo inicial da conta configurado",
    "financial_account.activated": "Conta financeira reativada",
    "financial_account.archived": "Conta financeira inativada",
...
function entityTypeLabel(entityType: string) {
  const labels: Record<string, string> = {
    ...
    cash_transfer: "Transferência entre contas",
    cash_period: "Período financeiro",
